...
const activeBtnStyles = 'bg-red-500 text-white font-bold p-2 rounded-full w-20 outline-none mr-4'
const notActiveBtnStyles = 'bg-primary mr-4 text-black p-2 rounded-full w-20 outline-none'
    ...
    <div className='relative p-2 h-full justify-center items-center'>
      <div className="flex flex-col pb-5 ">
        <div className="relative flex flex-col mb-7">
          ...
          <h1 className="font-bold text-2xl text-center m-3">{user.userName}</h1>
          <div className="absolute top-0 z-1 right-0 p-2">{userId === user._id && (  <GoogleLogout
            ...
            onLogutSuccess={logout}
            cookiePolicy="single_host_origin"
          />
          )}
          </div>
          </div>
          <div className="text-center mv-7">
